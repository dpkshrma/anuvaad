...
abstract class Model {
  ...
  public function delete($txn = null) {
    ...
    if ($this->key_name === null && $this->key_id === null) {
  ...
  public static function execute_gql($kind,$key_name,$txn=null){
    ...
    $gql_query->setQueryString("SELECT * FROM ".$kind." WHERE __key__ = @1");
